...
for AA in range(20):
    ''' show raw data '''
    npDepth = np.load(file_path+"depth/"+str(AA)+".0.npy")
    npColor = np.load(file_path+"color/"+str(AA)+".0.npy")
    ...
    file_path = '/home/ncslaber/110-1/211002_allLibrary/1008-different_side_trunk/forward/'
